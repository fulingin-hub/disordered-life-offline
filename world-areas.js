  ...
  const areas = [
    {
      ...
      sections: [
        ...
        },
        {
          ...
          label: "国立大学·夏国分校",
          image: "worldXiaCampus",
          description: "国立大学夏国分校本部，共六名职业角色和十二间正常、丧志个人房间。",
          characters: [],
          faction: "university",
          branch: "xia",
        },
        {
          ...
          characters: ["lin", "su", "restaurantCouple", "agencyCouple"], guild: true,
        },
        {
          id: "holy-light", label: "圣光教团据点",
          image: "worldSanctuaryCampus",
          description: "圣徒在夏国设立的圣光祝福与净化房间。",
          characters: [], holyLight: true,
        },
      ],
    },
    {
      ...
      sections: [
        ...
        },
        {
          ...
          label: "国立大学·岛国分校",
          image: "worldIslandCampus",
          description: "国立大学岛国分校本部，共六名职业角色和十二间正常、丧志个人房间。",
          characters: [],
          faction: "university",
          branch: "island",
        },
        {
          ...
          characters: ["miki", "kaori"], guild: true,
        },
        {
          id: "holy-light", label: "圣光教团据点",
          image: "worldSanctuaryCampus",
          description: "圣徒在岛国设立的圣光祝福与净化房间。",
          characters: [], holyLight: true,
        },
      ],
    },
    {
      ...
      sections: [
        ...
        },
        {
          ...
          label: "国立大学·米国分校",
          image: "worldRiceCampus",
          description: "国立大学米国分校本部，共六名职业角色和十二间正常、丧志个人房间。",
          characters: [],
          faction: "university",
          branch: "rice",
        },
        {
          ...
          characters: ["claire", "ruth", "victoria"], guild: true,
        },
        {
          id: "ranch",
          label: "米国牧场",
    ...
    },
    {
      ...
      sections: [{
        ...
        id: "church",
        label: "魔纹教会",
        image: "infernalChurchSanctuary",
        description: "七大欲的人间体，降临凡间，如果想成为魔纹贱畜就快点爬来跪好，接受教主的踩脸洗礼，成为光荣的魔纹贱畜吧！",
        characters: [],
        church: true,
      }, {
        id: "holy-light",
