(function (LG) {
  ...
  function build() {
    ...
    portrait.className = "infernal-stomp-queen";
    portrait.alt = "";
    ...
    scene.append(portrait, foot, shade, caption, button);
    dialog.append(scene);
